...
class UpgradeStrategy():
    ...
    def upgrade_shield(self):
        ...
        wait_click(self.serial, ArmorType.SHIELD.value)
        if not exist_click(self.serial, EnhancePageImg.ENHANCE.value, threshold=0.9):
        ...
        connection_retry(self.serial, vanish=[(EnhancePageImg.TEXT.value, 0.9)], timeout=30.0)
